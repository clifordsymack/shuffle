...
2. From `Shuffle change address` choose the address for the change. You can leave it default if you don't want to get any change back.
...
7. Pressing the `Shuffle` will start shuffling process. After 5 players registred on server shuffling process will starts.

8. If all goes good you will see the outputs and transaction dialog winodow in the end. If something goes wrong you will see the errors in output.

9. In this version of protocol some of player should press `broadcast` on transaction dialog window.    
